...
<div class="container-fluid">
    <div class="mb-3">
        <a href="{{ route('leaderboard.team') }}" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0  fw-bold">{{ $team->name }} Leaderboard</h1>
            <p class="text-muted mb-0">Rankings specifically for members of the {{ $team->name }} team.</p>
        </div>
        <div class="d-flex gap-2">
            <input type="hidden" id="teamFilter" value="{{ $team->name }}">
...
$(document).ready(function() {
    ...
    const table = $('#leaderboardTable').DataTable({
        ...
        columns: [
            ...
            { data: 'team', name: 'team', visible: false },

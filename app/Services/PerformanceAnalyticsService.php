...
class PerformanceAnalyticsService
{
    ...
    public static function calculateEmployeeScore(int $employeeId, ?int $gitCommitCount = null): array
    {
        ...
        return [
            ...
            'task_completion_rate' => (int) round($taskCompletionRate),
            'on_time_completion_rate' => (int) round($onTimeCompletionRate),
            'attendance_score' => (int) round($attendanceScore),
            'git_contribution_score' => (int) round($gitContributionScore),
            'final_leadership_score' => (int) round($finalScore),
